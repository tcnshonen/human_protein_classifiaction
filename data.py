#From https://github.com/spytensor/kaggle_human_protein_baseline
...
class Placeholder(Dataset):
    def __init__(self, num=4):
        self.num = num
        self.data = torch.rand(num, 3, 512, 512)
        self.target = torch.randint(0, 28, (self.num,), dtype=torch.long)
